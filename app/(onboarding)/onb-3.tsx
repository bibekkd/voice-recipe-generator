  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="absolute inset-0">
        <Image 
          source={require('../../assets/onboarding-images/onboardingThree.jpg')}
      ...
      <View className="flex-1 justify-between px-6 py-8">
        ...
        <View className="flex-1 justify-center items-center">
          <View className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 mx-4">
            <View className="items-center mb-6">
              ...
              <Text className="text-white/80 text-center text-base leading-6">
                Get personalized recipe suggestions based on your dietary preferences and nutritional goals
              </Text>
            </View>
          </View>
        </View>
